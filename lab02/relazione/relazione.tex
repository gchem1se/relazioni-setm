...
\subsection{Frequenza di taglio}
La frequenza di taglio del filtro passa-alto è pari a:
\begin{equation*}
	f_{T}=\frac{1}{2\pi RC}=\frac{1}{2\pi\cdot\SI{1021}{\ohm}\cdot\SI{10}{\nano\farad}}=\SI{15.59}{\kilo\hertz}
\end{equation*}
con un'incertezza pari a:
\begin{equation*}
	\delta f_{T}=\left|\frac{\partial f_{T}}{\partial R}\right|\delta R+\left|\frac{\partial f_{T}}{\partial C}\right|\delta C = \SI{3.12}{\kilo\hertz}
\end{equation*}
